...
1. Clone the repository to your local machine using git clone https://github.com/yourusername/ArticleImager.git
2. Navigate to the project directory using cd ArticleImager
